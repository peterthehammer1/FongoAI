...
/**
 * Working script to update the existing Fongo CC updater agent
 * Using the CORRECT API: PATCH https://api.retellai.com/update-agent/{agent_id}
 */

async function updateFongoAgentWorking() {
  try {
    ...
    console.log('🔧 Using CORRECT API: PATCH https://api.retellai.com/update-agent/{agent_id}');
    ...
    const updatePayload = {
      ...
      // Additional optimized settings that we know work
    ...
    // Make the API request using the CORRECT method and endpoint
    ...
    console.log('\n🎉 SUCCESS! Your Fongo Credit Card Update Agent is now perfectly configured!');
    console.log('📞 Ready for testing with phone calls!');
...
if (require.main === module) {
  updateFongoAgentWorking();
}

module.exports = { updateFongoAgentWorking };
